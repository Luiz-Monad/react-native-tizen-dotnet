...
namespace ReactNative.UIManager
{
    abstract class PropertySetter : IPropertySetter
    {
        ...
        public void UpdateViewManagerProperty(IViewManager viewManager, EvasObject view, ReactStylesDiffMap props)
        {
            if (viewManager == null)
        ...
        protected virtual object[] GetViewManagerArgs(EvasObject view, ReactStylesDiffMap props)
        {
        ...
        private void Invoke(object instance, object[] args)
        {
            ...
            {
                Log.Error(ReactConstants.Tag, $"Method.Invoke failed, Method name is {Method.Name}, args is {args}, instance is {instance}");
        ...
        class ViewManagerPropertySetter : PropertySetter
        {
            ...
            protected override Type GetPropertyType(MethodInfo method)
            {
                ...
                // TODO: boy.yang
                if (/*!typeof(EvasObject).IsAssignableFrom(parameters[0].ParameterType)*/false)
                {
                    throw new InvalidOperationException(
            ...
            protected override object[] GetViewManagerArgs(EvasObject view, ReactStylesDiffMap props)
            {
                s_args[0] = view;
