...
namespace ReactNative.Bridge
{
    ...
    public abstract class JavaScriptBundleLoader
    {
        ...
        class FileJavaScriptBundleLoader : JavaScriptBundleLoader
        {
            ...
            {
                //TODO: SourceUrl is relative path, How to get the project path, so can sssembly the Absolute path
                ...
                */
                ...
                Log.Info(ReactConstants.Tag, "## JavaScriptBundleLoader ## Bundle:["+ SourceUrl.ToString() + "]");
